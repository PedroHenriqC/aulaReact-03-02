    ...
    <div>
                ...
                <div className="container-mac">
                  ...
                  <div>
                    <ul className="modal-features">
                      <li className="">
                        💻 Chip M4 com CPU e GPU de até 10 núcleos
                      </li>
      ...
      <div className="container-card">
        ...
        <div className="card-produt">
          <div className="card-image">
            <img
              src="https://store.storeimages.cdn-apple.com/1/as-images.apple.com/is/ipad-pro-finish-select-202405-11inch-spaceblack-glossy-wifi_FMT_WHH?wid=1280&hei=720&fmt=p-jpg&qlt=80&.v=YXpaUEtKWGhlNnNrVGZkTEo4T0xsNEsrMGFueUl5dllOTm9xWTIwTHNid1VmMWkxN1U3QnRGTCt1bW5qUllQWGV0VFB1eEFsUkZXTUZIa3dLUEgvS05VRWVXSzdKNmQ4OUR2Q1RTYjk0V1lnK05jcGhxb0ZEQ0VxMXp5VmNrSEZxVUlyT2pReWpWRG9sWTcydDFOSUQxTkNhQllaajMwUWt6S2Fhakd2SHJV&traceId=1"
              alt=""
              className="card-image1"
            />
          </div>
          <h3 className="card-title">
            Apple Ipad Pro 11" Wi-Fi 512gb - Preto-Espacial (BR)
          </h3>
          <p>R$ 7.999,90</p>
          <div>
            <button>
        ...
        <div className="card-produt">
          <div className="card-image">
            <img
              src="https://cdsassets.apple.com/live/7WUAS350/images/tech-specs/mbp14-m4-2024.png"
              alt=""
              className="card-image1"
            />
          </div>
          <h3 className="card-title">
            Apple MacBook Pro Preto-Espacial 14" 16GB de Ram M4 1TB
          </h3>
          <p>R$ 16.399,00</p>
          <div>
            <button>
